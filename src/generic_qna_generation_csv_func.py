...
def generate_qna_generation_csv_func(logger: Logger, prompt: Optional[PromptTemplate] = None, parser: Optional[Union[JsonOutputParser, StrOutputParser, ListOutputParser]] = None, documents_path: Optional[str] = None, vector_db_collection_name: str = "farming_market", dataframe_path: str = "src/result/test21/qna_overall.csv", llm: Union[OpenAIClient, BaseLLM] = llm_anton_local_llama3, embeddings: OllamaEmbeddings = embeddings, model_name: str = "llama3"):
